...
let categories: [QuestionCategory] = [category1, category2, category3, category4]
...
// Categories
let category1 = QuestionCategory(id: 0, categoryName: "Procedimentos", questions: [question3, question4, question5, question6])
let category2 = QuestionCategory(id: 1, categoryName: "Pré-requisitos", questions: [question1, question2])
let category3 = QuestionCategory(id: 2, categoryName: "Locais de Doação", questions: [])
let category4 = QuestionCategory(id: 3, categoryName: "Lei", questions: [])
